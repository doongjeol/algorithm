		...
		while(!q.isEmpty()) {
			...
			for(int i=0 ; i<4 ; i++) {
				...
				case 0 :
					...
					if(number > 9999)
						number = number % 10000 ;
//					System.out.println("현재: "+cur+" D "+number);
					break;
				case 1 :
					number = cur - 1;
					if(number == -1)
						number = 9999;
//					System.out.println("현재: "+cur+" S "+number);
					break;
				case 2 :
					int d1 = cur/1000;
					int d2 = cur/100%10;
...
//					System.out.println("현재: "+cur+" L "+number);
					break;
				case 3 :
					d1 = cur/1000;
					d2 = cur/100%10;
					...
					break;
//					System.out.println("현재: "+cur+" R "+number);
				}
				...
				if(number == b) {
					...
					visited[number] = visited[cur] + dir[i];
//					System.out.println("현재: "+cur +" 문자: "+ visited[number] +" number: "+ number);
					q.add(number);
				}
